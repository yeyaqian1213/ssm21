...
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
			    	...
			    	<li class="layui-nav-item">
			    		<a href="out.htm?role=admin"><i class="iconfont icon-loginout"></i> 退出</a>
			    	</li>
					...
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							...
							<cite>${adminLogin.nickname}</cite>
						</a>
						<dl class="layui-nav-child">
							<dd><a href="javascript:;" data-url="page/user/userInfo.html"><i class="iconfont icon-zhanghu" data-icon="icon-zhanghu"></i><cite>个人资料</cite></a></dd>
							<dd><a href="javascript:;" data-url="page/user/changePwd.html"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>修改密码</cite></a></dd>
							<dd><a href="out.htm?role=admin"><i class="iconfont icon-loginout"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				...
				<p>你好！<span class="userName">${adminLogin.nickname}</span>, 欢迎登录</p>
			</div>
	...
	<div class="admin-header-lock" id="lock-box" style="display: none;">
		...
		<div class="admin-header-lock-name" id="lockUserName">${adminLogin.nickname}</div>
		<div class="input_btn">
